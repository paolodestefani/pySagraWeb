...
# exceptions
from database.Exceptions import PyAppDBConnectionError
from database.Exceptions import PyAppDBError
#from App.Core.ExceptionHandler import db_exception_context

# REGISTER CUSTOM PSYCOPG TYPES
import App.Database.Psycopg

from database import APPNAME
from database import APPVERSION
from database import PGMINVER
...
SELECT EXISTS(SELECT 1 
    ...
    WHERE pr.proname = 'pa_connect' 
        ...
        logging.info("pgminver = %s", PGSQL_MINVER)
