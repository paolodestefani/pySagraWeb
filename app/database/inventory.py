...
SELECT 9 AS type, 'KIT ITEMS' AS item, Null AS loaded, Null AS unloaded, Null AS stock, Null AS ordered, Null AS available
UNION ALL
SELECT 
	1					AS type,
...
SELECT 9 AS type, 'MENU ITEMS' AS item, Null AS loaded, Null AS unloaded, Null AS stock, Null AS ordered, Null AS available
UNION ALL
SELECT 
	2					AS type,
    item_description	AS item,
